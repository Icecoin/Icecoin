...
uint256 hashGenesisBlock("0xa3b5f0e383b4b84ce632d58ed34c46fc20eb0d40f47de642b05c222f4ef28922");
...
const string strMessageMagic = "Icecoin Signed Message:\n";
...
static const int64 nTargetSpacing = 60; // Icecoin: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Icecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Icecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x03846e932800403bdda5b966e33111b8e4fdf457977c7f0cac335c327c753e11");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "https://bitcointalk.org/index.php?topic=230922.msg2428058#new";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x6b148ecab8a84f39e976d1ed3df2e2a7b0010a1d6454550e089f49f8d8ce801b"));
